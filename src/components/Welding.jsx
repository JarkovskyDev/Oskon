    ...
    <div name='welding' className='w-full h-screen'>
       <div className='max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4'>
          ...
          <div className='flex flex-col h-full justify-center'>
            <h3 className='text-5xl md:text-6xl font-bold'>SVAŘOVÁNÍ</h3>
            <p className='text-xl text-justify pb-6'>Oskon s.r.o je odborníkem na oblast svařování a kovových výrobků spojených s touto technikou. Naše firma se zaměřuje na výrobu vysokojakostních svařovaných komponent pro různé odvětví průmyslu.  Také se zaměřujeme na svařování  konstrukcí ve stavebnictví, a to svařování  ocelových nosníků, nosných sloupků, rámových konstrukcí a dalších svařovaných prvků, které zajišťují stabilitu a bezpečnost budov. S důrazem na preciznost a bezpečnost jsme vaším spolehlivým partnerem pro kovové výrobky, které vám pomáhají dosáhnout excelentních svařovacích výsledků.</p>
          </div>
        </div>     
    </div>
  )
